...
VarDcl = tipo:Tipos _ id:Identificador _ exp:("=" _ exp:Expresion _ {return exp})?";" { return crearNodo('declaracionVariable', { tipo, id, exp }) }
        / "var" _ id:Identificador _ "=" _ exp:Expresion ";" { return crearNodo('declaracionVariable', { id, exp }) }

Tipos = "int" / "float" / "string" / "boolean" /"char"
...
Logica = izq:Igualacion expansion:(
...
Unaria = "-" _ num:Unaria { return crearNodo('unaria', { op: '-', exp: num }) }
        / "!" _ num:Unaria { return crearNodo('unaria', { op: '!', num }) }
        / Llamada
/ Llamada
